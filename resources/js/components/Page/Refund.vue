    ...
    <div>
        <main  v-if="$i18n.locale == 'en'">
            <div class="page-width">
                <div class="grid">
                    <div
                        class="grid__item medium-up--five-sixths medium-up--push-one-twelfth"
                    >
                        ...
                        <div class="rte">
                            ...
                            <p>You have 10 days to return your product.</p>
                            <p class="margin"></p>
                            <p>
                                <strong
                ...
                <div class = "grid">
                    ...
                    >
                        ...
                        <div class = "rte">
                            ...
                            <p> أمامك 10 أيام لإرجاع منتجك. </p>
                            <p class = "margin"> </p>
                            <p>
